...
MIGRATION_MODULES = {"sites": "acham.contrib.sites.migrations"}
...
ADMINS = [("""Kairat Sultan""", "gayratbek.sultonov@icloud.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "acham.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "acham.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "acham.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "acham.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "ACHAM Collection API",
    "DESCRIPTION": "Documentation of API endpoints of ACHAM Collection",
    "VERSION": "1.0.0",
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to ACHAM Admin",
    ...
    # Add a custom datepicker for date fields
    "datepicker": True,
    # Add a custom datetime picker for datetime fields
    "datetimepicker": True,
    # Add a custom time picker for time fields
    "timepicker": True,
}
...
UNSPLASH_ACCESS_KEY = env("UNSPLASH_ACCESS_KEY", default=None)
